...
namespace Chat_App.Migrations
{
    ...
    [Migration("20240916095308_improvingFriendRequest")]
    partial class improvingFriendRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatUser", b =>
                {
                    b.HasOne("Chat_App.Models.Chat", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Chat_App.Models.ContactList", b =>
                {
                    b.HasOne("Chat_App.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Chat_App.Models.Message", b =>
                {
                    b.HasOne("Chat_App.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");

                    b.HasOne("Chat_App.Models.User", "ReceiverUser")
                        .WithMany()
                        .HasForeignKey("ReceiverUserId");

                    b.HasOne("Chat_App.Models.User", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Chat_App.Models.User", b =>
                {
                    b.HasOne("Chat_App.Models.ContactList", null)
                        .WithMany("Contacts")
                        .HasForeignKey("ContactListId");

                    b.HasOne("Chat_App.Models.Profile", "Profile")
                        .WithMany()
